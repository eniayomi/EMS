...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Security | Exeat Details </title>
        
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"/>
        <meta charset="UTF-8">
        <meta name="description" content="Responsive Admin Dashboard Template" />
        <meta name="keywords" content="admin,dashboard" />
        <meta name="author" content="Eniayomi" />
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="font-size:24px;">Exeat Details</div>
                    </div>
                   
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Exeat Details</span>
                                        ...
                                        <tr>
                                          ...
                                          <tr>
                                            ...
                                            <td><?php echo htmlentities($result->EmailId);?></td>
                                             <td style="font-size:16px;"><b>Student Parents No. :</b></td>
...
<tr>
                                             <td style="font-size:16px;"><b>Student Exeat Description : </b></td>
...
<tr>
<td style="font-size:16px;"><b>Porters Remark: </b></td>
<td colspan="5"><?php
...
?></td>
 ...
 <tr>
<td style="font-size:16px;"><b>Porters Action taken date : </b></td>
<td colspan="5"><?php
